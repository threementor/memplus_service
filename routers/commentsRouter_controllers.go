...
func init() {
	...
	beego.GlobalControllerRouter["memplus_service/controllers:UserDeckRelaController"] = append(beego.GlobalControllerRouter["memplus_service/controllers:UserDeckRelaController"],
		beego.ControllerComments{
			Method: "Post",
			Router: `/`,
			AllowHTTPMethods: []string{"post"},
